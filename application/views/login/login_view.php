    ...
    <body>
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <i class="fa fa-cube"></i> <strong>RFID with SMS</strong>
            </h1>
            <!-- END Login Header -->
            ...
            <footer class="text-muted text-center animation-pullUp">
                <small> &copy; <a href="http://www.evenlyten.com" target="_blank">RFID with SMS</a><br>This system is developed by Evenly Ten Web Solutions.</small>
            </footer>
            <!-- END Footer -->
        </div>
        <!-- END Login Container -->
