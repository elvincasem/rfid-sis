                                    ...
                                    <form action="#" method="post" class="form-horizontal form-bordered" onsubmit="return false;">
                                        ...
                                        <div class="form-group form-actions">
                                            <div class="col-md-9 col-md-offset-3">
                                                <button type="submit" class="btn btn-effect-ripple btn-primary" onclick="returns_report_view();">Generate</button>
        ...
        <div class="block-title">
			...
			<a type="button" class="pull-right btn btn-md btn-primary" href="<?=base_url()?>reports/returnsdownload/<?php echo $datefrom;?>/<?php echo $dateto;?>">Export Result XLS</a>
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover">
				...
				foreach ($returnslist as $returns_list):
				//$heiname = strtoupper($hei['instname']);
				echo "<tr class='odd gradeX'>";
				
				
				//echo "<td>".mdate('%F %d, %Y',strtotime($aprlist['aprdate']))."</td>";
				echo "<td>".$returns_list['rreno']."</td>";
				echo "<td>".$returns_list['rredate']."</td>";
				echo "<td>".$returns_list['equipno']."</td>";
				echo "<td>".$returns_list['particulars']."</td>";
				echo "<td>1</td>";
				echo "<td>".$returns_list['paricsno']."</td>";
				echo "<td>".$returns_list['enduseroffice']."</td>";
				echo "<td>".$returns_list['rre_remarks']."</td>";
