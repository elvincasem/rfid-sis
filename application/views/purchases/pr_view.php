...
">DIRECT CONTRACTING (LIMITED TIME OF COMPLETION)
	...
	<div class="block full">
        ...
        <div class="table-responsive">
            <table id="example-datatable_pr" class="table table-striped table-bordered table-vcenter table-hover">
                <thead>
                    <tr>
                        <th>PR No.</th>
                        <th>APR No.</th>
			...
			<input type="hidden" id="lastpr" value="<?php echo $lastpr;?>">
