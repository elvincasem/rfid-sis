   ...
   <div class="col-lg-12">
	...
	<div class="block full">
        ...
        <div class="table-responsive">
            <table id="example-datatable_ra" class="table table-striped table-bordered table-vcenter table-hover">
                <thead>
				...
				echo "<td><a href='receivingassets/details/".$rrlist['deliveryid']."'>".$rrlist['deliveryid']."</a></td>";
